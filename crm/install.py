...
from crm.aoscrm.doctype.crm_products.crm_products import create_product_details_script
...
def add_default_fields_layout(force=False):
	quick_entry_layouts = {
		...
		"CRM Deal-Quick Entry": {
			"doctype": "CRM Deal",
			"layout": '[{"name":"title_section","editable":false,"columns":[{"name":"column_Ahsi","fields":["title"]}]},{"name":"organization_contact_section","editable":false,"columns":[{"name":"column_GpMP","fields":["organization"]},{"name":"column_FPTn","fields":["contact"]}]},{"name":"deal_section","columns":[{"name":"column_mdps","fields":["status"]},{"name":"column_H40H","fields":["deal_owner"]}]}]',
		},
		"Contact-Quick Entry": {
			"doctype": "Contact",
...
def add_standard_dropdown_items():
	crm_settings = frappe.get_single("AOSCRM Settings")
...
def add_default_scripts():
	from crm.aoscrm.doctype.aoscrm_settings.aoscrm_settings import create_forecasting_script
