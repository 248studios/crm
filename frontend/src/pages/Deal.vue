...
async function addContact(contact) {
  ...
  let d = await call('crm.aoscrm.doctype.crm_deal.crm_deal.add_contact', {
    deal: props.dealId,
    contact,
  })
  if (d) {
...
async function removeContact(contact) {
  let d = await call('crm.aoscrm.doctype.crm_deal.crm_deal.remove_contact', {
    deal: props.dealId,
    contact,
  })
  if (d) {
...
async function setPrimaryContact(contact) {
  let d = await call('crm.aoscrm.doctype.crm_deal.crm_deal.set_primary_contact', {
    deal: props.dealId,
    contact,
  })
  if (d) {
...
const dealContacts = createResource({
  url: 'crm.aoscrm.doctype.crm_deal.api.get_deal_contacts',
